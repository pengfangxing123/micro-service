...
public class SftpUtils {
     ...
     * 文件路径前缀. 
     */
    private static final String PRE_FIX = "/xhxtsftp/upload";
    ...
    public static void main(String[] args) throws Exception {
        ChannelSftp sftp = getSftpConnect("ftp-1.fuiou.com", 9022, "xhxtsftp", "Srdy23sdr9Pwus");
        String pathString = "C:\\Users\\fangxing.peng\\Desktop\\sftptest和.txt";
